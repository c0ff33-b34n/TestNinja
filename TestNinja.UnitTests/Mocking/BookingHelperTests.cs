...
namespace TestNinja.UnitTests.Mocking
{
    ...
    class BookingHelperTests
    {
        ...
        public void SetUp()
        {
            ...
            {
                Id = 2,
                ArrivalDate = ArriveOn(2020, 03, 26),
                DepartureDate = DepartOn(2020, 03, 29),
                Reference = "a"
            };
        ...
        public void OverlappingBookingsExist_BookingStartsAndFinishesBeforeAnExistingBooking_ReturnEmptyString()
        {
            ...
            {
                Id = 1,
                ArrivalDate = Before(_existingBooking.ArrivalDate, days: 4),
        ...
        [Test]
        public void OverlappingBookingsExist_BookingStartsInTheMiddleOfAnExistingBookingAndFinishesAfter_ReturnExistingBookingsReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
